"""
Template CRUD API Controller

Endpoints for creating, reading, updating, and deleting document templates.
"""
...
class TemplateCRUDAPIController(BaseAPIController):
    """
    ...
    def list_templates(self, **kwargs):
        ...
        # Serialize
        templates_data = [
            serialize_template(template) for template in paginated_templates
        ]
    ...
    def get_template(self, template_id, **kwargs):
        ...
        template_data = serialize_template(
            template,
