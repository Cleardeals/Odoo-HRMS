...
class TestDocumentSyncBasic(HREmployeeCleardealsTestCase):
    ...
    def test_02_document_sync_on_employee_update(self):
        ...
        self.assertGreater(
            new_count, initial_count, "Document count should increase after update",
        )
    ...
    def test_03_multiple_documents_sync(self):
        ...
        self.assertGreaterEqual(doc_count, 3, "At least 3 documents should be synced")
    ...
    def test_05_attachment_creation_on_sync(self):
        ...
        for doc in docs:
            self.assertTrue(
                len(doc.doc_attachment_ids) > 0, "Document should have attachments",
            )
    ...
    def test_06_document_update_replaces_existing(self):
        ...
        self.assertTrue(
            new_count >= initial_count, "Document count should not decrease",
        )
    ...
    def test_07_sync_does_not_duplicate_documents(self):
        ...
        self.assertTrue(
            count_after_update >= count_after_create,
    ...
    def test_09_empty_document_not_synced(self):
        ...
        self.assertEqual(len(pan_docs), 0, "Empty documents should not be synced")
    ...
    def test_10_sync_all_document_fields(self):
        ...
        self.assertGreaterEqual(doc_count, 10, "Should sync all document fields")
...
class TestDocumentSyncAdvanced(HREmployeeCleardealsTestCase):
    ...
    def test_01_bulk_employee_creation_with_documents(self):
        ...
        for emp in employees:
            ...
            self.assertGreater(
                doc_count, 0, f"Employee {emp.name} should have documents",
            )
    ...
    def test_03_document_type_reuse(self):
        ...
        self.assertEqual(
            initial_type_count, final_type_count, "Should reuse existing document types",
        )
    ...
    def test_05_attachment_mimetype_set_correctly(self):
        ...
        for doc in docs:
            for attachment in doc.doc_attachment_ids:
                self.assertTrue(
                    attachment.mimetype, "Attachment should have MIME type set",
                )
    ...
    def test_07_concurrent_document_updates(self):
        ...
        doc_count = self._count_documents_in_vault(employee)
        self.assertGreaterEqual(doc_count, 2, "Should handle concurrent updates")
