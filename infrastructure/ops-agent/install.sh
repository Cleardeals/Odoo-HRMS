...
ok ""
ok "verify from a workstation — all three of these return nothing today:"
ok "  gcloud logging read 'resource.type=\"gce_instance\"' --limit=5"
ok "  gcloud compute instances os-inventory describe odoo-hrms-prod --zone=us-central1-c"
